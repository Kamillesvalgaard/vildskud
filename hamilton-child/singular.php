...
if ( have_posts() )  : 
	...
	while ( have_posts() ) : the_post(); ?>
		...
		<body style='background-color:#f4e4ad'>


		<?php if( is_product(66,68,248,71,40) ) : ?>
			
			<p id="tilbage" ><a class="submit" href="javascript:history.go(-1)" title="Return to previous page">Tilbage</a></p>
			...
			<div class="entry-content section-inner merch">
